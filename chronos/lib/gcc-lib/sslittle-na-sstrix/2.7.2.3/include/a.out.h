...
#if defined (sequent) && defined (__i386__)
  struct gdtbl
...
#if	defined (hp300) || defined (__mips__)
#define	PAGE_SIZE	4096
#endif
#if	defined (__sparc__) || defined (NeXT)
#define	PAGE_SIZE	0x2000
#endif
#if	defined (sony) || (defined (__sun__) && defined (__mc68000__))
...
#endif
#if defined(__i386__) && !defined(sequent)
