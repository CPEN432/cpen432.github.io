...
/* Chronos notice:
 *------------------------------------------------------------------------------
 * We have commented out places involving selective compilation for functions
 * like _fatal(), _warn(), etc. since the compilation of them on modern
 * Linux/GCC produces many annoying warnings.
 *------------------------------------------------------------------------------
 */
